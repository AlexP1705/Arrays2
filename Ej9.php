...
if ($noPreferencesCount > 0) {
    $averageAge = $totalAge / $noPreferencesCount;
} else {
    $averageAge = 0;
}

echo "Total people with no preferences: $noPreferencesCount<br>";
echo "Average Age for people with no preferences: " . number_format($averageAge, 2) . "\n";
