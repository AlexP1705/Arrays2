...
$favoriteFood = "pasta"; // Reemplaza "pasta" con el plato de comida que deseas buscar
...
foreach ($data as $userData) {
    ...
    if (in_array($favoriteFood, $favorites)) {
        $foundUsers[] = $userData['User'];
        $country = $userData['Country'];
        if (!in_array($country, $foundCountries)) {
            $foundCountries[] = $country;
        }
    }
}

echo "Total de personas a las que les gusta $favoriteFood: " . count($foundUsers) . "<br>";
echo "Países de personas a las que les gusta $favoriteFood: " . implode(', ', $foundCountries) . "<br>";
