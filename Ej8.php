...
$countryInput = "Spain"; // Reemplaza "Spain" con el país que deseas buscar

$found = false;

echo "People from $countryInput<br>";
echo "-----------------------------<br>";

foreach ($data as $userData) {
    if (isset($userData['Country']) && strtolower($userData['Country']) === strtolower($countryInput)) {
        echo $userData['User'] . ' likes ';
...
if (!$found) {
    echo "No se encontraron usuarios de $countryInput.\n";
}
